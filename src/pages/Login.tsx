...
const Login = () => {
    ...
    const onSubmit = async (data: LoginFormData) => {
        try {
            ...
            // Small delay for toast to display
            setTimeout(() => {
    ...
    return (
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                ...
                <div className="text-center mb-8 animate-fade-in-down">
                    <div className="inline-block relative">
                        <div className="absolute inset-0 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full blur-lg opacity-75 animate-pulse" />
                ...
                <div className="relative animate-fade-in-up">
                    ...
                    <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
                        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 rounded-full" />
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 mt-4">
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-4 top-[42px] text-2xl hover:scale-110 transition-transform"
                                >
                                    {showPassword ? '👁️' : '👁️‍🗨️'}
                                </button>
                            </div>
                            ...
                            >
                                {isSubmitting ? 'Logging in...' : 'Launch Dashboard'}
                            </Button>
                        </form>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200">
                            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-50 to-pink-50 p-4 border border-purple-100">
                                ...
                                <div className="absolute -right-10 -bottom-10 w-32 h-32 bg-purple-200 rounded-full opacity-20" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        .animate-fade-in { animation: fade-in 0.6s ease-out 0.4s both; }
      `}</style>
        </div>
    );
};

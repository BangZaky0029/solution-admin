...
import { getPackages, createPackage, updatePackage, deletePackage, CreatePackagePayload } from '../api/controllers/packageController';
...
const Packages: FC = () => {
    ...
    const openModal = (pkg: Package | null = null): void => {
        if (pkg) {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        try {
            ...
            console.error('Submit package failed:', err);
        }
    };
